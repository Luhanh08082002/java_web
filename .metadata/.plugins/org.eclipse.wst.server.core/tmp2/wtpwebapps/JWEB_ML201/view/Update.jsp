		...
		<div class="right_container">
			...
			<div class="right_container_bt">
				...
				<div class="container_data">
					<form action="/JWEB_ML201/updateDepartment" method="post">
						<div class="data">
							<h4> SỬA PHÒNG BAN</h4>
							<div class="item_data">
								<h6>MÃ PHÒNG BAN</h6>
								<input type="text" class="item_data_text" name="department_id" value="${lis.department_id }" readonly>
							</div>
							<div class="item_data">
								<h6>TÊN PHÒNG BAN</h6>
								<input type="text" class="item_data_text" name="department_name" value="${lis.department_name }">
							</div>
							<div class="item_data">
								<h6>MÔ TẢ</h6>
								<input type="text" class="item_data_text" name="mota" value="${lis.mota }">
							</div>
							<div class="submit_button">
								<button class="create" type="submit">CẬP NHẬT</button>

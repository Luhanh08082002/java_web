		...
		<div class="right_container">
			...
			<div class="right_container_bt">
				...
				<div class="container_data">
					<div class="data_item_depatrtment">8 PHÒNG BAN</div>
					<div class="data_item_depatrtment">14 NHÂN VIÊN</div>
					<div class="data_item_depatrtment">16 TÀI KHOẢN</div>
				</div>
			</div>
		</div>
	</div>
